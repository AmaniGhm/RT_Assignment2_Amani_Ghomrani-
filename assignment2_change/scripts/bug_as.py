...
def planning(goal):
    ...
    feedback = assignment2_change.msg.PlanningFeedback()
    result = assignment2_change.msg.PlanningResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('/reaching_goal', assignment2_change.msg.PlanningAction, planning, auto_start=False)
